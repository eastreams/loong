...
REPORT_MONTH="${LOONG_ARCH_REPORT_MONTH:-${LOONG_ARCH_REPORT_MONTH:-$(date +%Y-%m)}}"
OUTPUT_PATH="${1:-docs/releases/support/architecture-drift-${REPORT_MONTH}.md}"
EXPLICIT_BASELINE="${LOONG_ARCH_DRIFT_BASELINE_REPORT:-${LOONG_ARCH_DRIFT_BASELINE_REPORT:-}}"
EXPLICIT_BASELINE_DIR="${LOONG_ARCH_DRIFT_BASELINE_DIR:-${LOONG_ARCH_DRIFT_BASELINE_DIR:-}}"
