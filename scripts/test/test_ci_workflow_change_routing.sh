...
assert_contains "$WORKFLOW_PATH" "scripts/ci/workflow_change_router.mjs"
...
assert_contains "$WORKFLOW_PATH" "./scripts/ci/run_changed_rust_ci_job.sh"
assert_contains "$WORKFLOW_PATH" "./scripts/ci/run_changed_rust_ci_job.sh --all-features"
