...
assert_contains ".github/workflows/security.yml" "scripts/ci/workflow_change_router.mjs"
...
assert_contains ".github/workflows/codeql.yml" "scripts/ci/workflow_change_router.mjs"
