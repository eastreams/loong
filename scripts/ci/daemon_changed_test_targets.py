...
Examples:
  python3 scripts/ci/daemon_changed_test_targets.py crates/daemon/tests/integration/onboard_cli.rs
  git diff --name-only | python3 scripts/ci/daemon_changed_test_targets.py --format json
"""
