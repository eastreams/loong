...
Examples:
  python3 scripts/ci/rust_changed_packages.py --format names crates/app/src/lib.rs
  python3 scripts/ci/rust_changed_packages.py --format cargo-args Cargo.lock
"""
