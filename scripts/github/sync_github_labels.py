...
GENERATED_HEADER = "# Generated by scripts/github/sync_github_labels.py. Do not edit manually.\n\n"
MARKDOWN_GENERATED_HEADER = "<!-- Generated by scripts/github/sync_github_labels.py. Do not edit manually. -->\n\n"
...
def check_targets(targets: dict[Path, str]) -> int:
    ...
    if mismatches:
        ...
        print("Run `python3 scripts/github/sync_github_labels.py --write` to refresh them.", file=sys.stderr)
        return 1
    return 0
