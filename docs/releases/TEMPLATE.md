...
|---|---:|---|---|
| loongclaw-vX.Y.Z-x86_64-unknown-linux-gnu.tar.gz | 0 | <sha256> | [link](https://github.com/loongclaw-ai/loongclaw/releases/download/vX.Y.Z/<asset>) |
...
- [GitHub release page](https://github.com/loongclaw-ai/loongclaw/releases/tag/vX.Y.Z)
