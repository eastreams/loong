...
This is the preferred path for channels such as Tlon, Zalo, Zalo Personal, or
WebChat surfaces before real config or runtime support lands. Channels such as
Email, generic Webhook, LINE, DingTalk, Google Chat, Signal, Nostr, Twitch,
