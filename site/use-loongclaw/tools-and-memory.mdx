...
LoongClaw's public operator model is built around governed capability exposure.
...
| --- | --- |
| the visible-tool contract | [Tool Surface](/use-loongclaw/tool-surface) |
| continuity and profile selection | [Memory Profiles](/use-loongclaw/memory-profiles) |
| the supporting safety posture | [Security And Reliability](/reference/security-and-reliability) |

## Where To Go Next

- Continue to [Tool Surface](/use-loongclaw/tool-surface) for the truthful visible-tool contract.
- Continue to [Memory Profiles](/use-loongclaw/memory-profiles) for the public continuity contract.
