...
| --- | --- |
| a hosted provider plus a team-chat runtime | [Volcengine Plus Feishu Or Lark](/use-loongclaw/volcengine-feishu-lark-playbook) or [WeCom Rollout](/use-loongclaw/wecom-rollout-playbook) |
| a dedicated coding lane plus a lightweight bot surface | [BytePlus Coding Plus Telegram](/use-loongclaw/byteplus-coding-telegram-playbook) |
| provider-only local setup without delivery guidance | [Provider Recipes](/use-loongclaw/provider-recipes) |
...
- Continue to [Common Setups](/use-loongclaw/common-setups) for the setup hub.
- Continue to [Provider Recipes](/use-loongclaw/provider-recipes) for the
  broader local and self-hosted provider cookbook.
- Continue to [Channel Recipes](/use-loongclaw/channel-recipes) for the
  broader outbound-only delivery cookbook.
