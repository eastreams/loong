...
| --- | --- |
| WeCom as the primary enterprise lane | [WeCom Rollout](/use-loongclaw/wecom-rollout-playbook) |
| BytePlus Coding plus a lightweight bot surface | [BytePlus Coding Plus Telegram](/use-loongclaw/byteplus-coding-telegram-playbook) |
| one host supervising several already-healthy runtime-backed channels | [Gateway Rollout](/use-loongclaw/gateway-rollout-playbook) |
...
- Continue to [Common Setups](/use-loongclaw/common-setups) for other end-to-end
  rollout shapes.
- Continue to [Channel Recipes](/use-loongclaw/channel-recipes) for the
  tutorial-style channel cookbook.
