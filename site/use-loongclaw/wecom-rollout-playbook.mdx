...
| --- | --- |
| Feishu or Lark as the primary team-chat runtime | [Volcengine Plus Feishu Or Lark](/use-loongclaw/volcengine-feishu-lark-playbook) |
...
- Continue to [Channel Recipes](/use-loongclaw/channel-recipes) for the broader
  channel cookbook.
