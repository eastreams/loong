...
description: Choose how LoongClaw preserves continuity without turning memory into a second authority.
---

# Memory Profiles

LoongClaw exposes memory as an operator-visible choice rather than one hidden
global mode.
...
- Go to [Tools And Memory](/use-loongclaw/tools-and-memory) for the combined governed-capability overview.
- Go to [Tool Surface](/use-loongclaw/tool-surface) if you want the truthful visible-tool contract.
