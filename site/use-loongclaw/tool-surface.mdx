---
title: Tool Surface
description: How LoongClaw keeps runtime-visible tools truthful and governed.
---

# Tool Surface

LoongClaw treats the visible tool catalog as part of the product contract.
...
- Go to [Tools And Memory](/use-loongclaw/tools-and-memory) for the higher-level governed-capability overview.
- Go to [Memory Profiles](/use-loongclaw/memory-profiles) for continuity behavior and profile selection.
