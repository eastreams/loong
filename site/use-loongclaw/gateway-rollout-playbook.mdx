...
| --- | --- |
| one hosted provider plus a Feishu or Lark room from near-zero | [Volcengine Plus Feishu Or Lark](/use-loongclaw/volcengine-feishu-lark-playbook) |
| WeCom as the main enterprise lane from near-zero | [WeCom Rollout](/use-loongclaw/wecom-rollout-playbook) |
| BytePlus Coding plus one Telegram bot from near-zero | [BytePlus Coding Plus Telegram](/use-loongclaw/byteplus-coding-telegram-playbook) |
...
- Continue to [Common Setups](/use-loongclaw/common-setups) for the broader
  end-to-end setup hub.
- Continue to [Channel Recipes](/use-loongclaw/channel-recipes) if one of the
