---
title: Installation
description: Install LoongClaw from release artifacts or source.
---

# Installation

LoongClaw prefers a release-first install path.
...
- `loong` is the primary command and `loongclaw` stays as a compatibility entrypoint.
