...
LoongClaw uses `doctor` as the main repair path when the base runtime is unhealthy.
...
- Move on to [Use LoongClaw](/use-loongclaw/overview) once the base local runtime is healthy.
