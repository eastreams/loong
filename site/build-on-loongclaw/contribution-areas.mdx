...
description: Where different kinds of contributors can create real leverage in LoongClaw.
---

# Contribution Areas

LoongClaw needs more than one kind of contributor.

The public contribution story is intentionally broader than "write core runtime
code".

Use the repository's
[contribution-areas reference](https://github.com/loongclaw-ai/loongclaw/blob/dev/docs/references/contribution-areas.md)
...
| --- | --- | --- |
| product and interface design | designers with strong product judgment and trust-sensitive UX instincts | LoongClaw should feel legible and humane, not only technically capable |
...
- what part of LoongClaw feels most worth building
