...
| --- | --- | --- |
| understand the public crate and layer model first | this page | [Contributing](/build-on-loongclaw/contributing) or the deeper references below |
| decide which crate or layer should own a change | this page | [Contribution Workflow](/build-on-loongclaw/contribution-workflow) once the ownership is clear |
| inspect the fuller repository-native architecture map | [ARCHITECTURE.md](https://github.com/loongclaw-ai/loongclaw/blob/dev/ARCHITECTURE.md) | the deeper design docs linked at the end |
| edit docs placement or public docs boundaries | [Docs Workflow](/build-on-loongclaw/docs-workflow) | [Documentation Policy](/reference/documentation-policy) |
...
| Crate | Public role |
| --- | --- |
| `contracts` | shared types and stable contract boundary |
| `kernel` | capability, policy, audit, and pack-governed execution core |
| `protocol` | transport contracts and route model |
| `app` | providers, tools, memory, channels, and conversation engine |
| `spec` | deterministic execution-spec runner |
| `bench` | performance benchmark harness |
| `daemon` | runnable operator CLI and service entrypoints |
...
- [ARCHITECTURE.md](https://github.com/loongclaw-ai/loongclaw/blob/dev/ARCHITECTURE.md)
- [Core Beliefs](https://github.com/loongclaw-ai/loongclaw/blob/dev/docs/design-docs/core-beliefs.md)
- [Layered Kernel Design](https://github.com/loongclaw-ai/loongclaw/blob/dev/docs/design-docs/layered-kernel-design.md)
- [Harness Engineering](https://github.com/loongclaw-ai/loongclaw/blob/dev/docs/design-docs/harness-engineering.md)
