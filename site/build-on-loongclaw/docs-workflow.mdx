---
title: Docs Workflow
description: How LoongClaw's public docs are split, validated, and deployed from this repository.
---

# Docs Workflow

LoongClaw keeps public docs deliberately split across three layers so the
...
- README explains what LoongClaw is and where to begin.
...
LoongClaw's public docs are meant to deploy from this same repository as a
...
5. Re-run Mintlify validation when the site navigation, page links, or locale wiring changes.

## Continue Reading

- Continue to [Contributing](/build-on-loongclaw/contributing) for the public contribution entrypoint.
- Continue to [Contribution Workflow](/build-on-loongclaw/contribution-workflow) for the standard PR and validation bar.
