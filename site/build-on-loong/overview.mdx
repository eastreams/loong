...
| How do I build or demo a WebAssembly bridge plugin? | [WASM Plugins](/build-on-loong/wasm-plugins) | it explains manifest discovery, the demo JSON ABI, and the bundled source-visible plugin |
...
2. Read [WASM Plugins](/build-on-loong/wasm-plugins) when your extension is a manifest-first WebAssembly bridge.
3. Read [Contributing](/build-on-loong/contributing) next if you are preparing a real patch.
4. Read [Contribution Workflow](/build-on-loong/contribution-workflow) if you need the public validation and PR lane.
5. Read [Docs Workflow](/build-on-loong/docs-workflow) when the patch is primarily about public docs structure, placement, or Mintlify delivery.
6. Read [Contribution Areas](/build-on-loong/contribution-areas) if you want to match your background to current leverage points.
7. Read [Reference](/reference/overview) or [Documentation Policy](/reference/documentation-policy) when you need the surrounding public contract and docs boundary.
