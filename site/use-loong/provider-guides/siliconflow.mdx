---
title: SiliconFlow
description: Configure the SiliconFlow provider profile in Loong.
---

# SiliconFlow

Use this when your team already runs on SiliconFlow and you want that vendor family to stay explicit in Loong config instead of disappearing behind a generic compatibility route.

## At A Glance

| Field | Value |
| --- | --- |
| Built-in kind | `siliconflow` |
| Provider group | Direct Hosted Providers |
| Protocol family | `openai_chat_completions` |
| Feature family | `openai_compatible` |
| Auth scheme | `bearer` |
| Credential envs | SILICONFLOW_API_KEY |
| Aliases | `siliconflow_compatible` |
| Default base URL | `https://api.siliconflow.com` |
| Request endpoint | `https://api.siliconflow.com/v1/chat/completions` |
...
| OAuth env | none |
| Primary request route | `https://api.siliconflow.com/v1/chat/completions` |
| Primary model-catalog route | `https://api.siliconflow.com/v1/models` |
