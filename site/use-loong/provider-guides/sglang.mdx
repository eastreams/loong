---
title: SGLang
description: Configure the SGLang provider profile in Loong.
---

# SGLang

Local or self-hosted servers where the model boundary stays operator-owned. This page covers the built-in `sglang` provider kind directly.

## At A Glance

| Field | Value |
| --- | --- |
| Built-in kind | `sglang` |
...
| Default base URL | `http://127.0.0.1:30000` |
| Request endpoint | `http://127.0.0.1:30000/v1/chat/completions` |
| Models endpoint | `http://127.0.0.1:30000/v1/models` |
...
| OAuth env | none |
| Primary request route | `http://127.0.0.1:30000/v1/chat/completions` |
| Primary model-catalog route | `http://127.0.0.1:30000/v1/models` |
