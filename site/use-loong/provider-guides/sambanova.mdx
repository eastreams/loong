---
title: SambaNova
description: Configure the SambaNova provider profile in Loong.
---

# SambaNova

Use this when your team already runs on SambaNova and you want that vendor family to stay explicit in Loong config instead of disappearing behind a generic compatibility route.

## At A Glance

| Field | Value |
| --- | --- |
| Built-in kind | `sambanova` |
| Provider group | Direct Hosted Providers |
| Protocol family | `openai_chat_completions` |
| Feature family | `openai_compatible` |
| Auth scheme | `bearer` |
| Credential envs | SAMBANOVA_API_KEY |
| Aliases | `sambanova_compatible`, `samba_nova` |
| Default base URL | `https://api.sambanova.ai` |
| Request endpoint | `https://api.sambanova.ai/v1/chat/completions` |
| Models endpoint | `https://api.sambanova.ai/v1/models` |
...
| Default API key env | `SAMBANOVA_API_KEY` |
| OAuth env | none |
| Primary request route | `https://api.sambanova.ai/v1/chat/completions` |
| Primary model-catalog route | `https://api.sambanova.ai/v1/models` |
