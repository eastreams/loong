---
title: llama.cpp
description: Configure the llama.cpp provider profile in Loong.
---

# llama.cpp

Local or self-hosted servers where the model boundary stays operator-owned. This page covers the built-in `llamacpp` provider kind directly.
