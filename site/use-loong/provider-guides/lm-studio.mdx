---
title: LM Studio
description: Configure the LM Studio provider profile in Loong.
---
...
| Request endpoint | `http://127.0.0.1:1234/v1/chat/completions` |
...
| OAuth env | none |
| Primary request route | `http://127.0.0.1:1234/v1/chat/completions` |
| Primary model-catalog route | `http://127.0.0.1:1234/v1/models` |
