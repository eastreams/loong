...
| WhatsApp Personal | `whatsapp_personal.enabled`, `bridge_url`, `auth_dir`, `allowed_chat_ids` | `./scripts/whatsapp-personal-bridge-run.sh`, `loong doctor`, `loong channels`, `loong channels send whatsapp-personal`, `loong channels serve whatsapp-personal`, managed bridge discovery |
