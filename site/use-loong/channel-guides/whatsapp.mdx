...
- Keep the Cloud API credential path distinct from any future scan-to-link or personal-account pairing help surface so operators do not confuse QR-style account linking with `access_token` / `phone_number_id` provisioning.
