...
contributors, and builders can understand the contract LoongClaw is actually
trying to ship.
...
- **Fail loud with a repair path**: when setup or runtime health breaks, LoongClaw should push users toward `doctor` rather than silent failure.

## Current Public Product Contract

The public MVP journey is intentionally short:

1. Install LoongClaw through the documented installer or source path.
2. Run `loong onboard`.
...
- [Product Sense](https://github.com/loongclaw-ai/loongclaw/blob/dev/docs/PRODUCT_SENSE.md)
- [Roadmap](https://github.com/loongclaw-ai/loongclaw/blob/dev/docs/ROADMAP.md)
- [Product Specs Index](https://github.com/loongclaw-ai/loongclaw/blob/dev/docs/product-specs/index.md)
