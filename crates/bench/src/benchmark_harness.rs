...
use loong_spec::{
    CliResult, NativeToolExecutor, ProgrammaticCircuitBreakerPolicy,
...
pub use wasm_cache::{copy_benchmark_file, run_wasm_cache_benchmark_cli};
...
mod tests {
    ...
    fn benchmark_copy_strategy_defaults_to_stable_fs_copy() {
        assert_eq!(
            wasm_cache::benchmark_copy_strategy_from_env(None),
            wasm_cache::BenchmarkCopyStrategy::StableFsCopy
        );
        assert_eq!(
            wasm_cache::benchmark_copy_strategy_from_env(Some("".to_owned())),
            wasm_cache::BenchmarkCopyStrategy::StableFsCopy
        );
        assert_eq!(
            wasm_cache::benchmark_copy_strategy_from_env(Some("copy".to_owned())),
            wasm_cache::BenchmarkCopyStrategy::StableFsCopy
        );
        assert_eq!(
            wasm_cache::benchmark_copy_strategy_from_env(Some("unexpected".to_owned())),
            wasm_cache::BenchmarkCopyStrategy::StableFsCopy
        );
    }
    ...
    fn benchmark_copy_strategy_accepts_explicit_clone_opt_in() {
        assert_eq!(
            wasm_cache::benchmark_copy_strategy_from_env(Some("clone".to_owned())),
