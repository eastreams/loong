...
pub(super) async fn run_twitch_send(
    ...
    let request_url = format!("{}/chat/messages", api_base_url.trim_end_matches('/'));
...
async fn validate_twitch_access_token(
    ...
    let request_url = format!("{}/validate", oauth_base_url.trim_end_matches('/'));
...
async fn resolve_twitch_broadcaster(
    ...
    let api_base_url = resolved.resolved_api_base_url();
    let request_url = format!("{}/users", api_base_url.trim_end_matches('/'));
