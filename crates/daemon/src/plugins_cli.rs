...
use crate::kernel::{
    CURRENT_PLUGIN_HOST_API, CURRENT_PLUGIN_MANIFEST_API_VERSION, Capability,
    PACKAGE_MANIFEST_FILE_NAME, PluginBridgeKind, PluginCompatibility, PluginManifest,
    plugin_runtime_scaffold_defaults,
};
use crate::{
    BridgeSupportSpec, CliResult, JsonSchemaDescriptor, MaterializedBridgeSupportDeltaArtifact,
    PluginInventoryResult, PluginPreflightProfile, PluginPreflightResult, execute_spec,
