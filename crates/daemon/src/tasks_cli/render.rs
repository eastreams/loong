...
pub fn render_task_detail_lines(task: &Value) -> CliResult<Vec<String>> {
    ...
    let prompt_frame_summary =
        crate::session_runtime_detail::render_prompt_frame_summary(task.get("prompt_frame"));
    let safe_lane_summary =
        crate::session_runtime_detail::render_safe_lane_summary(task.get("safe_lane"));
    let turn_checkpoint_summary =
        crate::session_runtime_detail::render_turn_checkpoint_summary(task.get("turn_checkpoint"));
