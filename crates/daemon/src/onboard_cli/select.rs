use super::prompt_ui::{rich_prompt_term, rich_prompt_theme};
...
pub(super) fn build_onboard_shortcut_screen_options(
    ...
    vec![
        OnboardScreenOption {
            ...
            detail_lines: vec![crate::onboard::presentation::shortcut_continue_detail().to_owned()],
            recommended: true,
        },
        OnboardScreenOption {
            key: "2".to_owned(),
            label: crate::onboard::presentation::adjust_settings_label().to_owned(),
            detail_lines: vec![crate::onboard::presentation::shortcut_adjust_detail().to_owned()],
            recommended: false,
        },
    ]
}
