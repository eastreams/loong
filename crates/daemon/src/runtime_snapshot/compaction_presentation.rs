...
mod tests {
    ...
    use crate::runtime_snapshot::compaction_hygiene::RuntimeSnapshotCompactionHygieneWindow;
    use crate::runtime_snapshot::compaction_sequence::RuntimeSnapshotCheckpointRepairManualReason;
    ...
    fn fixture() -> RuntimeSnapshotCompactionHygieneState {
        RuntimeSnapshotCompactionHygieneState {
            ...
            primary_lineage:
                crate::runtime_snapshot::compaction_hygiene::RuntimeSnapshotCompactionLineageState {
