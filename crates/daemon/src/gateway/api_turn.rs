...
pub(crate) async fn handle_turn(
    ...
    let agent_turn_request = crate::mvp::agent_runtime::AgentTurnRequest {
    ...
    let trusted_hook_result = crate::trusted_host_runtime::dispatch_turn_start_hook_for_request(
        config,
