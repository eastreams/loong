...
fn runtime_snapshot_fixture(
    ...
    loongclaw_daemon::gateway::read_models::GatewayRuntimeSnapshotReadModel {
        ...
        audit: loongclaw_daemon::gateway::read_models::GatewayRuntimeSnapshotAuditReadModel {
            mode: "in_memory".to_owned(),
            journal_path: String::new(),
            integrity_journal_path: String::new(),
            integrity_key_path: String::new(),
            integrity_seal_path: String::new(),
            integrity_status: "disabled".to_owned(),
            protected_entries: 0,
            last_event_id: None,
            integrity_detail: String::new(),
        },
