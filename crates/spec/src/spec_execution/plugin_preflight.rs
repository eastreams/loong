...
mod tests {
    ...
    fn sample_inventory_result() -> PluginInventoryResult {
        PluginInventoryResult {
            ...
            channel_bridge_transport_family: None,
            channel_bridge_target_contract: None,
            channel_bridge_account_scope: None,
            channel_bridge_runtime_contract: None,
            channel_bridge_runtime_operations: Vec::new(),
            channel_bridge_runtime_operation_specs: Vec::new(),
            channel_bridge_ready: None,
            channel_bridge_missing_fields: Vec::new(),
            connector_operations: Vec::new(),
            connector_operation_specs: Vec::new(),
            connector_operation_metadata_issues: Vec::new(),
