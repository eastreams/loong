...
pub use plugin_ir::{
    ...
    PluginConnectorOperationDeclarations, PluginIR, PluginNativeExtensionDeclarations,
    PluginNativeExtensionEventSpec, PluginNativeExtensionHostActionSpec,
    ...
    evaluate_plugin_setup_requirements, plugin_connector_operation_declarations_from_metadata,
